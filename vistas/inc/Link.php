<link rel="icon" type="image/x-icon" href="<?php echo SERVERURL; ?>vistas/assets/icons/favicon.ico" />
<link rel="favicon" type="image/x-icon" href="<?php echo SERVERURL; ?>vistas/assets/icons/favicon.png" />
<link rel="apple-touch-icon" type="image/x-icon" href="<?php echo SERVERURL; ?>vistas/assets/icons/apple-touch-icon.png" />
